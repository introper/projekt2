...
$config['first_tag_open'] = '<li class="page-item"><a class="page-link" href="http://localhost/projekt2/vojevudce/10/1""';
...
$config['last_tag_open'] = '<li class="page-item"><a class="page-link"href="http://localhost/projekt2/vojevudce/10/50""';
